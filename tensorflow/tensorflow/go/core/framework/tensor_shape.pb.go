...
func (*TensorShapeProto) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{0} }
...
func (*TensorShapeProto_Dim) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{0, 0} }
...
func init() { proto.RegisterFile("github.com/tensorflow/tensorflow/tensorflow/go/core/framework/tensor_shape.proto", fileDescriptor20) }
