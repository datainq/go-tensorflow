...
func (*KernelDef) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
func (*KernelDef_AttrConstraint) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{0, 0} }
...
func init() { proto.RegisterFile("github.com/tensorflow/tensorflow/tensorflow/go/core/framework/kernel_def.proto", fileDescriptor9) }
