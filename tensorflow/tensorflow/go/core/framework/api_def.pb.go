...
func (ApiDef_Visibility) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{0, 0} }
...
func (*ApiDef) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*ApiDef_Endpoint) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0, 0} }
...
func (*ApiDef_Arg) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0, 1} }
...
func (*ApiDef_Attr) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0, 2} }
...
func (*ApiDefs) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func init() { proto.RegisterFile("github.com/tensorflow/tensorflow/tensorflow/go/core/framework/api_def.proto", fileDescriptor1) }
