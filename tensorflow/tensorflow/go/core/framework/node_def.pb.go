...
func (*NodeDef) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{0} }
...
func init() { proto.RegisterFile("github.com/tensorflow/tensorflow/tensorflow/go/core/framework/node_def.proto", fileDescriptor11) }
