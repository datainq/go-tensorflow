...
func (*ResourceHandleProto) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{0} }
...
func init() { proto.RegisterFile("github.com/tensorflow/tensorflow/tensorflow/go/core/framework/resource_handle.proto", fileDescriptor15) }
