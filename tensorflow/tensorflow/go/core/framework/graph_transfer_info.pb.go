...
func (*GraphTransferInfo) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (*GraphTransferInfo_NodeInput) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0, 0} }
...
func (*GraphTransferInfo_NodeInfo) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0, 1} }
...
func (*GraphTransferInfo_NodeInputInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor7, []int{0, 3}
}
...
func (*GraphTransferInfo_NodeOutputInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor7, []int{0, 4}
}
...
func (*GraphTransferInfo_GraphInputNodeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor7, []int{0, 5}
}
...
func (*GraphTransferInfo_GraphOutputNodeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor7, []int{0, 6}
}
...
func init() {
	proto.RegisterFile("github.com/tensorflow/tensorflow/tensorflow/go/core/framework/graph_transfer_info.proto", fileDescriptor7)
}
