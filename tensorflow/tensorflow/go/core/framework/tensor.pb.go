...
func (*TensorProto) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{0} }
...
func (*VariantTensorDataProto) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{1} }
...
func init() { proto.RegisterFile("github.com/tensorflow/tensorflow/tensorflow/go/core/framework/tensor.proto", fileDescriptor18) }
