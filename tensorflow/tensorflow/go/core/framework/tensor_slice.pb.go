...
func (*TensorSliceProto) Descriptor() ([]byte, []int) { return fileDescriptor21, []int{0} }
...
func (*TensorSliceProto_Extent) Descriptor() ([]byte, []int) { return fileDescriptor21, []int{0, 0} }
...
func init() { proto.RegisterFile("github.com/tensorflow/tensorflow/tensorflow/go/core/framework/tensor_slice.proto", fileDescriptor21) }
