...
func (*VariableDef) Descriptor() ([]byte, []int) { return fileDescriptor23, []int{0} }
...
func (*SaveSliceInfoDef) Descriptor() ([]byte, []int) { return fileDescriptor23, []int{1} }
...
func init() { proto.RegisterFile("github.com/tensorflow/tensorflow/tensorflow/go/core/framework/variable.proto", fileDescriptor23) }
