...
func (*VersionDef) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{0} }
...
func init() { proto.RegisterFile("github.com/tensorflow/tensorflow/tensorflow/go/core/framework/versions.proto", fileDescriptor24) }
