...
func (*TensorDescription) Descriptor() ([]byte, []int) { return fileDescriptor19, []int{0} }
...
func init() {
	proto.RegisterFile("github.com/tensorflow/tensorflow/tensorflow/go/core/framework/tensor_description.proto", fileDescriptor19)
}
